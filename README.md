...
│  │
│  ├─ equity_TW.png
│  │   └─ 📈 台股 Equity Curve（自動生成）
│  │
│  └─ equity_US.png
│      └─ 📈 美股 Equity Curve（自動生成）
│
├─ scripts/
│  ├─ ai_tw_post.py
│  │   └─ 🇹🇼 台股 AI 分析、預測與 Discord 推播
│  │
│  ├─ ai_us_post.py
│  │   └─ 🇺🇸 美股 AI 分析、預測與 Discord 推播
│  │
│  ├─ news_radar.py
│  │   └─ 📰 新聞雷達與黑天鵝事件偵測模組
│  │
│  ├─ performance_dashboard.py
│  │   └─ 📊 績效統計 Dashboard + Equity Curve 產生
│  │
│  ├─ horizon_optimizer.py
│  │   └─ 🔁 Horizon 初始化與策略控制（Freeze 狀態下僅觀測）
│  │
│  ├─ l4_defense_mode.py
│  │   └─ 🛡️ L4 黑天鵝防禦主邏輯
│  │
